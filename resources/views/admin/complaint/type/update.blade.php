@php
    ...
    $postRoute = route('admin.complaint.type.update.submit', ['id' => $complaintType->id]);
    $indexRoute = route('admin.complaint.type.index');
@endphp
                ...
                <div class="panel-body">
                    <div class="row">
                        <div class="col-md-6 col-xs-6">
                            <h4><b>{{$pageName}} Güncelle: {{ $complaintType->id }}</b></h4>
                        </div>
                                ...
                                <div class="col-md-6 col-xs-12">
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-8 col-xs-12">
                                            <input type="text" class="form-control" name="name" id="name" value="{{ $complaintType->name }}" required>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-6 col-xs-12">
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-8 col-xs-12">
                                            <input type="text" class="form-control" name="description" id="description" value="{{ $complaintType->description }}">
                                        </div>
                                    </div>
                                </div>
