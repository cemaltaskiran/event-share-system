                                ...
                                <div class="row">
                                    <div class="col-md-3 col-sm-6 col-xs-6">
                                        <div class="form-group">
                                            <label for="keyword">Kategori adı</label>
                                    ...
                                    <tbody>
                                        ...
                                        @else
                                            @foreach ($eventCategories as $eventCategory)
                                                ...
                                                @php
                                                    $updateUrl = route('admin.category.update', ['id' => $eventCategory->id]);
                                                    $deleteUrl = route('admin.category.delete', ['id' => $eventCategory->id]);
                                                @endphp
                                                <td>
