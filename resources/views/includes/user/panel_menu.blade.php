...
<nav class="navbar navbar-default" style="margin-bottom:0!important;">
    <div class="container-fluid">
        <ul class="nav navbar-nav">
            ...
            <li class="dropdown @if ($routeName == $prefix.".event.index" || $routeName == $prefix.".event.create" || $routeName == $prefix.".event.update" || $routeName == $prefix.".event.joined.index") active @endif">
                ...
                <ul class="dropdown-menu">
                    ...
                    <li><a href="{{ route($prefix.'.event.joined.index') }}">Katıldığın Etkinlikler</a></li>
                </ul>
            </li>
        </ul>
    </div>
