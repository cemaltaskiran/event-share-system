@php
    ...
    $rowNum = 2;
    $createRoute = route('event.create');
@endphp
        ...
        <div class="col-md-12">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    ...
                    <hr>
                    <div class="row">
                        {!! Form::open(['route' => 'event.index', 'method' => 'GET', 'class' => '', 'role' => 'search'])  !!}
                            <div class="col-md-3 col-xs-12">
                                <div class="input-group">
                                    {!! Form::text('search', Request::get('search'), ['class' => 'form-control', 'placeholder' => 'Etkinlik adı girin..']) !!}
