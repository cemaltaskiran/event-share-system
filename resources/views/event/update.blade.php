@php
    ...
    $postRoute = route('event.update.submit', ['id' => $event->id]);
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-8 col-xs-12">
                                                    <select class="single-city form-control" name="city" id="city" required>
                                                        <option></option>
                                                        @for ($i=0; $i < 81; $i++)
                                                            <option value="{{$cities->city[$i]->code}}" @if ($event->city == $cities->city[$i]->code) selected @endif>{{$cities->city[$i]->name}}</option>
                                                        @endfor
                                                    </select>
                                                </div>
                                            </div>
