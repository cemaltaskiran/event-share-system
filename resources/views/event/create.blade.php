@php
    ...
    $postRoute = route('event.post');
    $indexRoute = route('event.index');
@endphp
                        ...
                        <form class="form-horizontal" method="POST" name="form" action="{{ $postRoute }}" enctype="multipart/form-data">
                            <div class="col-md-12">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-8 col-xs-12">
                                                <select class="single-city form-control" name="city" id="city" required>
                                                    <option></option>
                                                    @for ($i=0; $i < 81; $i++)
                                                        <option value="{{$cities->city[$i]->code}}" @if (old('city') == $cities->city[$i]->code) selected @endif>{{$cities->city[$i]->name}}</option>
                                                    @endfor
                                                </select>
                                            </div>
                                        </div>
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            <button type="submit" class="btn btn-default center-block">{{$pageName}} Ekle</button>
                                        </div>
                                    </div>
                                </div>
                            </div>
